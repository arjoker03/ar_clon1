...
\033[1;91m☞ Auther     : AR_CYBER_HACKER_BD
\033[1;92m☞ WhatsApp   : 01997745734
\033[1;95m☞ FB    :ADRIYAN RIDOY
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update AR_HRIDOY Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' AR HRIDOY WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $AR_HRIDOY')
	    os.system('cd $HOME && git clone https://github.com/arjoker03/ar_clon1.git )
	    ...
	    psb('WhatsApp Num 01997745734✓')
	    psb('WellCome To AR_HRIDOY')
	    psb('Congratulations HRIDOY Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 200403✓')
	    psb('🔓Password ☆ 200403✓')
	    psb('ADD FB = https://www.facebook.com/itz.joker.5832 ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/AR_HRIDOY && python2 B4.py')
	elif bm =='3':
